...
try
{
	...
	if(request.getParameter("btn_login")!=null) //check login button click event not null
	{
		...
		pstmt=con.prepareStatement("select emai,studentcode from voter where emai=? AND studentcode=?"); //sql select query 
		...
		if(rs.next())
		{
			...
			if(email.equals(dbemail) && password.equals(dbpassword))
			{
				...
				response.sendRedirect("voteraction.jsp"); //after login success redirect to welcome.jsp page
			}
		}
		else
		{
        ...
        <form class="form-register" method="post" name="myform" onsubmit="return validate();">
            ...
            <div class="form-register-with-email">
                ...
                <div class="form-white-background">
				  ...
				  <a href="homePage.jsp" class="form-log-in-with-existing1">Go to homePage </a>
